...
//        zooKeeper = new ZooKeeper("localhost:2181,localhost:2182,localhost:2183", SESSION_TIMEOUT, watcher);
    ...
    public void testCreate() {
        String result = null;
        try {
            result = zooKeeper.create("/yangdemo", "alex~12345".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        } catch (Exception e) {
    ...
    public void testGetData() {
        String result = null;
        try {
            byte[] bytes = zooKeeper.getData("/yangdemo", false, null);
